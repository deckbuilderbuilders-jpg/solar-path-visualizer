  ...
  theme: {
    ...
    extend: {
      colors: {
        ...
        "house-wall": "hsl(var(--house-wall))",
        "house-roof": "hsl(var(--house-roof))",
        "panel-blue": "hsl(var(--panel-blue))",
        "panel-highlight": "hsl(var(--panel-highlight))",
        "wire-orange": "hsl(var(--wire-orange))",
        "battery-green": "hsl(var(--battery-green))",
